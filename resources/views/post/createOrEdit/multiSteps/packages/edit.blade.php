        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title title-3" id="successModalLabel">Success!</h4>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="showPreloader()">Done</button>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center mt-4">
                                                <a id="skipBtn" href="{{ \App\Helpers\UrlGen::post($post) }}"
                                                    class="btn btn-default btn-lg">
                                                    {{ t('Skip') }}
                                                </a>
                                                <button id="submitPostForm" class="btn btn-success btn-lg submitPostForm">
                                                    {{ t('Pay') }} </button>
                                            </div>
                                        </div>
                ...
                $('#submitPostForm').on('click', function(e) {
                    ...
                    setTimeout(function() {
                        ...
                        setTimeout(function() {
                            ...
                            // Handle form submission after the modal is closed
