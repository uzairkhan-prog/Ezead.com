...
@endsection
<style>
    .custom-hide-checkbox-button .create-page-custom-hide {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 page-content">
                    <div class="inner-box-custom-hide">
                                ...
                                <form class="form-horizontal" id="postForm" method="POST"
                                    ...
                                    <fieldset>
                                        @if (isset($picturesLimit) && is_numeric($picturesLimit) && $picturesLimit > 0)
                                            ...
                                            <div id="picturesBloc" class="input-group row custom-hide-checkbox-button">
                                                <label class="col-md-3 form-label{{ $picturesError }}" for="pictures">
                                                    {{ t('pictures') }} </label>
                                                ...
                                                <div class="col-md-12 text-center pt-2"
                                                    ...
                                                    @endphp
                                                        ...
                                                        @endphp
                                                        @if (
                                                            (($packageId == null || $packageId == 1) && $totalCount < 20) ||
                                                                ($packageId == 2 && $totalCount < 30) ||
                                                                ($packageId == 3 && $totalCount < 40) ||
                                                                ($packageId == 4 && $totalCount < 50))
                                                            <a id="uploadButton" class="btn btn-primary">Upload Images</a>
                                                        @endif
                                        ...
                                        <div class="input-group row mt-4">
                                            <div class="col-md-12 text-center">
                                                <a href="{{ url('posts/create') }}"
                                                    class="btn btn-default btn-lg me-3 px-4">{{ t('Previous') }}</a>
                                                <button id="nextStepBtn" class="btn btn-lg px-5" style="color: #ffffff; background-color: #23222f">
                                                    {{ $nextStepLabel ?? t('Next') }} </button>
                                            </div>
                                        </div>
...
@section('after_scripts')
    ...
    $(document).ready(function() {
            $('#uploadButton').on('click', function() {
                $('#pictureField').click(); // Trigger file input click
            });
        });
