    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 page-content">
                <div class="inner-box-create category-content p-5" style="overflow: visible;">
                    <h2 class="title-2">
                    ...
                    <div class="row">
                            ...
                            <form class="form-horizontal" id="postForm" method="POST" action="{{ request()->fullUrl() }}" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row required">
                                        ...
                                        <label class="col-md-3 text-start col-form-label{{ $categoryIdError }}">
                                            {{ t('category') }} <sup>*</sup>
                                        </label>
                                    </div>
                                    <div class="row mb-3 required">
                                        <div class="col-md-3"></div>
                                        <div class="col-md-6">
                                          <a href="#browseCategories" data-bs-toggle="modal" class="cat-link" data-id="{{ old('category_id', $categoryslugid->id ?? '0') }}">
                                            <div id="catsContainer" class="rounded{{ $categoryIdError }}">
                                                    {{ old('category_name', $categoryslugid->name ?? t('select_a_category')) }}
                                            </div>
                                          </a>
                                        </div>
                                        <input type="hidden" name="category_id" id="categoryId" value="{{ old('category_id', $postInput['category_id'] ?? $categoryslugid->id ?? '0') }}">
                                    ...
                                    @endphp
                                    <div id="postTypeBloc" class="row required">
                                        <div class="col-md-3"></div>
                                        <label class="col-md-3 text-start col-form-label">{{ t('type') }}
                                            <sup>*</sup></label>
                                    </div>
                                    ...
                                    <div class="row required">
                                        <div class="col-md-3"></div>
                                        <label class="col-md-3 text-start col-form-label{{ $titleError }}" for="title">{{ t('title') }} <sup>*</sup></label>
                                    </div>
                                    <div class="row mb-3 required">
                                        <div class="col-md-3"></div>
                                        <div class="col-md-6">
                                    ...
                                    @endphp
                                    <?php ?>
                                    <div id="priceBloc" class="row">
                                        <div class="col-md-3"></div>
                                        <label class="col-md-3 text-start col-form-label{{ $priceError }}" for="price">{{ t('price') }}</label>
                                    </div>
                                    ...
                                    <div class="row required">
                                        <div class="col-md-3"></div>
                                        <label class="col-md-3 text-start col-form-label{{ $countryCodeError }}" for="country_code">
                                    ...
                                    <input type="hidden" id="selectedAdminType" name="selected_admin_type" value="1">
                                    <input type="hidden" id="selectedAdminCode" name="selected_admin_code" value="CA.01">
                                    <input type="hidden" id="selectedCityId" name="selected_city_id" value="8500">
                                    <input type="hidden" id="selectedCityName" name="selected_city_name" value="Calgary, Alberta">
                                    @endif
                                    ...
                                    {{-- @php
                                        ...
                                        @endphp
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label{{ $tagsError }}" for="tags">{{ t('Tags') }} <sup>*</sup></label>
                                    <div class="col-md-8 {{ $tagsError }}">
                                        <select id="tags" name="tags[]" class="form-control tags-selecter{{ $tagsError }}" multiple="multiple">
                                            @if (!empty($tags))
                                        ...
                                        <div class="invalid-feedback">
                                            @foreach ($errors->get('tags.*') as $tagError)
                                            {{ $tagError[0] }}<br>
                                            @endforeach
                                        </div>
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-3"></div>
                            <label class="col-md-3 text-start col-form-label{{ $tagsError }}" for="tags">{{ t('Tags') }}</label>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                        ...
                        <div class="content-subheading d-none">
                        ...
                        $emailValue = auth()->check() && isset(auth()->user()->email) ? auth()->user()->email : data_get($postInput, 'email');
                        @endphp
                        <div class="row auth-field-item required{{ $forceToDisplay }}">
                            <div class="col-md-3"></div>
                            <label class="col-md-3 text-start col-form-label{{ $emailError }}" for="email">{{ t('email') }}
                        ...
                        <div class="row auth-field-item required{{ $forceToDisplay }}">
                            <div class="col-md-3"></div>
                            <label class="col-md-3 text-start col-form-label{{ $phoneError }}" for="phone">{{ t('phone_number') }}
                        ...
                        <div class="row mb-3 auth-field-item">
                            <div class="col-md-3"></div>
                            <label class="col-md-3 text-start col-form-label" for="website-url">
                                Website URL
                            </label>
                        </div>
                        <div class="row mb-3 auth-field-item">
                            ...
                            <div class="col-md-6 col-lg-8 col-xl-6">
                                <div class="input-group">
                                    ...
                                    <input id="website-url" name="website_url" class="form-control input-md" type="text" placeholder="Website Url" value="{{ old('website_url') }}">
                                    <span class="input-group-text iti-group-text">
                                        <input id="websiteUrlHidden" name="website_url_hidden" type="checkbox" value="1" @checked(old('website_url_hidden')=='1' )>
                                        &nbsp;<small>{{ t('Hide') }}</small>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 pt-3">
                            <div class="col-md-12 text-center">
                                <button id="nextStepBtn" class="btn btn-primary btn-lg" style="background-color: #d9d9d9!important;color: #051e44;padding: 10px 40px;font-size: 18px;">
                                    {{ t('Next') }}
                                </button>
                            </div>
                        </div>
        ...
        <div class="col-md-3 reg-sidebar d-none">
            @includeFirst([
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var categoryLink = document.querySelector('#categoryDropdownContainer a');
