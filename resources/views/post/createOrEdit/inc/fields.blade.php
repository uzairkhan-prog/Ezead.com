...
@if (!empty($fields))
	@foreach($fields as $field)
		...
		@if ($modelFieldType == 'checkbox')
			...
			{{-- checkbox --}}
			<div class="row {{ $requiredClass }}" style="margin-top: -10px;">
				<div class="col-md-3"></div>
				<label class="col-md-3 text-start col-form-label" for="{{ $fieldId }}"></label>
			</div>
		...
		@elseif ($modelFieldType == 'checkbox_multiple')
			...
			@if (!empty($fieldOptions))
				...
				<div class="row {{ $requiredClass }}" style="margin-top: -10px;">
					<div class="col-md-3"></div>
					<label class="col-md-3 text-start col-form-label" for="{{ $fieldId }}">
						{{ data_get($field, 'name') }}
				...
				<div class="row mb-3 {{ $requiredClass }}" style="margin-top: -10px;">
					...
					@endphp
					<div class="col-md-6"{!! $cmFieldStyle !!}>
		...
		@elseif ($modelFieldType == 'select')
			...
			<div class="row {{ $requiredClass }}">
				<div class="col-md-3"></div>
				<label class="col-md-3 text-start col-form-label{{ $errorClass }}" for="{{ $fieldId }}">
					{{ data_get($field, 'name') }}
					@if (data_get($field, 'required') == 1)
						<sup>*</sup>
					@endif
