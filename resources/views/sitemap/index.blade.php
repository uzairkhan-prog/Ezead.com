                        ...
                        <div class="content-box">
                            <div class="row row-featured-category">
                                <div class="col-12 box-title">
                                    <h2 class="px-3">
                                        <span class="title-3 fw-bold"><i class="fas fa-list"></i>
                                            {{ t('list_of_categories_and_sub_categories') }}</span>
                                    </h2>
                                </div>
                                    ...
                                    <div class="list-categories-children styled">
                                        <div class="row">
                                            @foreach ($cats as $key => $col)
                                                <div
                                                    class="col-md-4 col-sm-4{{ count($cats) == $key + 1 ? ' last-column' : '' }}">
                                                    @foreach ($col->sortBy('name') as $iCat)
                                                        <?php
                                                        ...
                                                        <div class="cat-list">
                                                            ...
                                                            <ul
                                                                ...
                                                                @if (isset($subCats) && $subCats->has($iCat->id))
                                                                    @foreach ($subCats->get($iCat->id)->sortBy('name') as $iSubCat)
                                                                        <li>
                                                                            <a
                                        ...
                                        <div class="inner">
                                            <h2 class="px-3">
                                                <span class="title-3 fw-bold">
                                                    <i class="fas fa-map-marker-alt"></i> {{ t('list_of_cities_in') }}
                                                    {{ config('country.name') }}
                                                </span>
                                            </h2>
                                        </div>
                                        ...
                                        <div class="list-categories-children">
                                            <div class="row">
                                                @foreach ($cities as $key => $cols)
                                                    <ul
                                                        class="cat-list col-lg-3 col-md-4 col-sm-6 px-4{{ $cities->count() == $key + 1 ? ' cat-list-border' : '' }}">
