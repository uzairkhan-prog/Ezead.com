...
<head>
    ...
    <!--for google search console verifaction-->
    <meta name="google-site-verification" content="NYgbFZPHCtmPXwP73OGZ4YJtJ5E8XjMOzO-E0DXn340" />
    ...
    @if (config('lang.direction') == 'rtl')
        ...
        <link href="{{ url('public/css/app.rtl.css') }}" rel="stylesheet">
    @else
        {{-- Custom Hide - Orignal --}}
        {{-- <link href="{{ url(mix('css/app.css')) }}" rel="stylesheet"> --}}
        {{-- Custom Add - After Page Load CSS --}}
        <link rel="preload" href="{{ url('public/css/app.css') }}" as="style"
    ...
    ?>
    {{-- Custom Hide - Orignal --}}
    {{-- <link href="{{ url('public/css/custom.css') . getPictureVersion() }}" rel="stylesheet">
    <link href="{{ url('public/css/mobileCustom.css') . getPictureVersion() }}" rel="stylesheet"> --}}

    {{-- Custom Add - After Page Load CSS --}}
    <link rel="stylesheet" href="{{ url('public/css/custom.css') . getPictureVersion() }}">
    <noscript>
        <link href="{{ url('public/css/custom.css') . getPictureVersion() }}" rel="stylesheet">
    </noscript>
    <link rel="preload" href="{{ url('public/css/mobileCustom.css') . getPictureVersion() }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link href="{{ url('public/css/mobileCustom.css') . getPictureVersion() }}" rel="stylesheet">
    </noscript>
    <link rel="preload" href="{{ url('public/css/custom-theme.css') . getPictureVersion() }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link href="{{ url('public/css/custom-theme.css') . getPictureVersion() }}" rel="stylesheet">
    </noscript>
...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1524317920264753"crossorigin="anonymous"></script>
    ...
    <script src="{{ url('public/assets/plugins/modernizr/modernizr-custom.js') }}"></script> --}}
    {{-- Custom Add - After Page Load JS --}}
    <script src="{{ url('public/assets/js/pace.min.js') }}" defer></script>
    <script src="{{ url('public/assets/plugins/modernizr/modernizr-custom.js') }}" defer></script>
    @yield('captcha_head')
    ...
    <style>
        ...
        /*.light .nav-mobile-scrolling-links .main-category-wrapper {*/
        /*    color: rgba(0, 0, 0, .55);*/
        /*}*/
...
<!-- user way org cscript accessability menu control -->
<script src="https://cdn.userway.org/widget.js" data-account="6taP6K9RRJ"></script>
...
<div id="loader" class="loader-container">
   ...
   <script>
    ...
    <script src="{{ url('public/js/scroll-top.js') }}"></script>
    <script src="{{ url('public/js/app.js') }}"></script>
    @if (config('settings.optimization.lazy_loading_activation') == 1)
        <script src="{{ url('public/assets/plugins/lazysizes/lazysizes.min.js') }}" async=""></script>
    @endif
    @if (file_exists(public_path() . '/assets/plugins/select2/js/i18n/' . config('app.locale') . '.js'))
        <script src="{{ url('public/assets/plugins/select2/js/i18n/' . config('app.locale') . '.js') }}"></script>
    @endif
    @if (config('plugins.detectadsblocker.installed'))
 ...
 --}}
    ...
    {{-- <script src="{{ url('public/assets/js/mask/ ') }}"></script> --}}
