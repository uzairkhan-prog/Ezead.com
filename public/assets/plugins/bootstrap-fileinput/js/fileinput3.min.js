    ...
    (i.prototype = {
      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          (v =
            '<button type="button" class="{removeClass} create-page-custom-hide" title="{removeTitle}"><input name="pictures[]" class="form-check-input defaultCheck1" type="checkbox" {dataUrl}{dataKey} value=""></button><button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n'),
          (w =
      ...
      _setProgress: function (e, i, a, r) {
        ...
        if (((i = i || n.$progress), i.length)) {
          ...
          if (e >= 100) {
            var formVal = $(".custom_update_form").val();
            if (formVal === "1") {
