...
|
*/
Route::get('/load-more-posts', [HomeController::class, 'loadMorePosts']);

Route::get('reload-captcha', [RegisterController::class, 'reloadCaptcha']);

Route::get('social', function(){
   return view('discourse.social'); 
});
			...
			->group(function ($router) {
				...
				Route::namespace('CreateOrEdit\MultiSteps')
					...
					->group(function ($router) {
						...
						Route::get('posts/create/add-title', 'getAddTitle')->name('get-add-title');
						Route::post('posts/create/add-title', 'postAddTitle')->name('post-add-title');
...
// SEARCH BAR IN DROP-DOWN
Route::controller(SearchDropdownController::class)->group(function () {
	Route::get('get-advance-search-location', 'getAdvanceSearchLocation')->name('get-advance-search-location');
	Route::get('get-categories', 'getCategories')->name('get-categories');
	Route::get('get-advance-search-categories', 'getAdvanceSearchCategories')->name('get-advance-search-categories');
	Route::get('get-advance-search-sub-categories', 'getAdvanceSearchSubCategories')->name('get-advance-search-sub-categories');
	Route::get('get-provinces', 'getProvinces')->name('get-provinces');
	Route::get('get-regions', 'getRegions')->name('get-regions');
	Route::get('get-cities', 'getCities')->name('get-cities');
	Route::get('get-neighbours', 'getNeighbours')->name('get-neighbours');
	Route::post('save-location', 'saveLocation')->name('save-location');
	Route::get('save-location', 'saveLocation')->name('save-location-get');
	Route::get('get-clear-section', 'clearSection')->name('get-clear-section');
	Route::get('get-clear-section-search', 'clearSectionSearch')->name('get-clear-section-search');
	Route::post('post-send-mail', 'postSendMail')->name('post-send-mail');
// 	Route::get('deleteuserProfilePhoto', 'deleteuserProfilePhoto')->name('deleteuserProfilePhoto');
	Route::post('custom-delete-post-pictures', 'customDeletePostPictures')->name('custom-delete-post-pictures');
	Route::post('update-active-status', 'updateActiveStatus')->name('update-active-status');
});

// SEARCH BAR IN DROP-DOWN
Route::controller(SearchController::class)->group(function () {
	Route::get('/advance-search', 'advanceSearch')->name('advance-search');
// 	Route::match(['get', 'post'], '/test', 'showUploadForm')->name('test');
});

Route::post("web/logout", [\App\Http\Controllers\Web\Auth\LoginController::class, "logout"]);