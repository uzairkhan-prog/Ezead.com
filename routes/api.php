...
Route::delete('deleteuserProfilePhoto/{id}', [App\Http\Controllers\Search\SearchDropdownController::class, 'deleteuserProfilePhoto'])->name('deleteuserProfilePhoto');
});
Route::get('gettimezone', [SearchDropdownController::class, 'gettimezone']);
Route::group(['prefix' => 'provience'], function () {
   
		Route::get('get-provinces',  [SearchDropdownController::class, 'getProvinces']);
		Route::get('get-regions',    [SearchDropdownController::class, 'getRegions']);
		Route::get('get-cities',     [SearchDropdownController::class, 'getCities']);
		Route::get('get-neighbours', [SearchDropdownController::class, 'getNeighbours']);
		Route::get('save-location', [SearchDropdownController::class, 'saveLocation']);
...
// users
// Route::put('users/{id}/photo', [UserController::class, 'updatePhoto']);
Route::prefix('users')
	...
	->group(function ($router) {
		...
		Route::middleware(['auth:sanctum'])
			->group(function ($router) {
				...
				Route::post('update-profile-pic', 'updateUserProfilePic')->name('users.update.profile.pic');
			});
