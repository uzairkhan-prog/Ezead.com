...
class Picture extends BaseModel
{
	...
	*/
	...
	public function getFilenameHtml(): string
	{
        ...
        // return '<img src="' . imgUrl($thumbSmall) . '" class="img-rounded" style="width:auto; max-height:90px;">';
		
        // Orignal
        return '<img src="' . imgUrl($this->filename, 'small') . '" class="img-rounded" style="width:100%;height:90px;">';
	}
	...
	protected function filename(): Attribute
	{
		return Attribute::make(
			get: function ($value, $attributes) {
				...
				// Custom Add
				if (empty($value) || !$disk->exists($value) || $value == null) {
					if ($value === 'app/default/picture.jpg') {
						$value = config('larapen.core.picture.default');
					}
				}
