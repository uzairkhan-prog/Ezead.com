...
trait WizardTrait
{
	...
	private function getEditFormMenu(Request $request, $post = null)
	{
		...
		// Start Custom Add View to Listing Portion of BreadCrumb -> Edit Post Page
		$condition = true;
		$urlViewListing = \App\Helpers\UrlGen::post($post);
		$menu[] = [
			'condition' => $condition,
			'class'     => $class,
			'url'       => $urlViewListing,
			'name'      => 'View to listing',
		];
		// End Custom Add View to Listing Portion of BreadCrumb -> Edit Post Page
