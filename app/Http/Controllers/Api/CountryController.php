...
class CountryController extends BaseController
{
	...
	public function index(): \Illuminate\Http\JsonResponse
	{
		...
		$cacheId = 'countries.' . $cacheEmbedId . (int)$isNonActiveIncluded . '.page.' . $page;
		
		// Cached Query
		$countries = cache()->remember($cacheId, $this->cacheExpiration, function () use ($embed, $isNonActiveIncluded) {
